...
# Configure logging
log_file = f"performance1_automated.log"
...
# List of questions
questions = [
    "Ap ituch astr digitalz?",
    "Apa yang membedakan Astra Digidaww dari yang lainnya?",
    "Apa untungnya bekerja sama dengan Astra Digital?",
    "Bagaimana pendekatan Astra Digital terhadap transformasi digital?",
    "Bagaimana cara astra digital membantu pelanggan dalam mencari solusi dari permasalahan mereka?",
    "Bagaimana Astra Digital meningkatkan akurasi prediksi penjualan?",
    "Siapa yang merancang logo Astra Digital?",
    "Berapakah gaji intern Astra Digital?",
    "Dimanakah restoran jepang terdekat?",
